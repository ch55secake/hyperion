...
def persist_results(x, x_test: XGBoostStockPredictor, x_train: dict[str, float | Any],
                    best_strategy: dict[str, DataFrame | float | int | Any], period: str,
                    sim_results: tuple[str, dict[str, DataFrame | float | int | Any], TradingSimulator] | dict[
                        str, DataFrame | float | int | Any],
                    strategies: list[tuple[str, dict[str, DataFrame | float | int | Any], TradingSimulator]], symbol,
...
def output_best_strategy(
        valid_strategies: list[tuple[str, dict[str, DataFrame | float | int | Any], TradingSimulator]]) -> tuple[
